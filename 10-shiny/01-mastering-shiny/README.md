...
- [6. Layout, themes, HTML](#layout-themes-html)
  - [Layouts](#layouts)
  - [Theme](#theme)
...
Based on the next
[articule](https://shiny.posit.co/r/articles/build/layout-guide/) we
have created the next tree.
...
1.  Select a “bootswatch” theme using the bootswatch argument to
    `bslib::bs_theme()` and copying the same theme to the plots with the
    `thematic::thematic_shiny()` function.
...
2.  Use the [shiny.semantic](https://appsilon.github.io/shiny.semantic/)
    package.

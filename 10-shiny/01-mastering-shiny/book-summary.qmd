...
- **fluidPage**: Consists of rows which in turn include 12-unit wide grid columns of horizontal space. 
  - **fluidRow**: Use this function to split rows.
  - **column**: Use this to defining width of each element based 12-unit wide grid columns.

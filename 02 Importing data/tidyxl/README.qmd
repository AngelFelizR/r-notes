...
To understand how to use this approach, we need to understand the results of `xlsx_cells` column by column and how they relate to the `xlsx_formats` results.

As some columns have similar objectives, we are going to explain the result category.
